...
public class MPlayer implements IMPlayer,MediaPlayer.OnBufferingUpdateListener,
    ...
    private void playStart(){
        Log.v("MediaPlayer","isVideoSizeMeasured:"+isVideoSizeMeasured+"    isMediaPrepared:"+isMediaPrepared+"    isSurfaceCreated:"+isSurfaceCreated+"    isUserWantToPlay:"+isUserWantToPlay+"    isResumed:"+isResumed);
